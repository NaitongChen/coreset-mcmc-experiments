...
Threads.@threads for i in 1:n_run
    println(i)
    KLs[i,1] = load("logistic_regression_coresetMCMC_" * "10_0.5_" * string(500) * "_" * string(i) * ".jld", "kl")
    ...
    KLs[i,9] = load("logistic_regression_coresetMCMC_" * "0.1_" * string(500) * "_" * string(i) * ".jld", "kl")
end
...
Threads.@threads for i in 1:n_run
    println(i)
    m1 = load("logistic_regression_coresetMCMC_" * "10_0.5_" *string(500) * "_" * string(i) * ".jld", "mean")
    ...
    m_method = load("logistic_regression_coresetMCMC_" * "0.1_" *string(500) * "_" * string(i) * ".jld", "mean")
...
Threads.@threads for i in 1:n_run
    println(i)
    m1 = load("logistic_regression_coresetMCMC_" * "10_0.5_" * string(500) * "_" * string(i) * ".jld", "cov")
    ...
    m_method = load("logistic_regression_coresetMCMC_" * "0.1_" * string(500) * "_" * string(i) * ".jld", "cov")
...
for i in 1:n_run
    println(i)
    m_method = load("logistic_regression_coresetMCMC_" * "10_0.5_" * string(500) * "_" * string(i) * ".jld", "θs")
    time = load("logistic_regression_coresetMCMC_" * "10_0.5_" * string(500) * "_" * string(i) * ".jld", "c_time")
    ...
    m_method = load("logistic_regression_coresetMCMC_" * "0.1_" * string(500) * "_" * string(i) * ".jld", "θs")
    time = load("logistic_regression_coresetMCMC_" * "0.1_" * string(500) * "_" * string(i) * ".jld", "c_time")
    time = time[end] - time[25001]
    m_method = reduce(hcat, m_method)'
    m_method = m_method[50001:end, :]
    split = rand(10000, 1, size(D_stan, 2))
