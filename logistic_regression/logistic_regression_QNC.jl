...
function main(args)
    ...
    kernel = MCMCsampler.QuasiNewtonCoreset(kernel = MCMCsampler.SliceSamplerMD(), t=20, K=50, ls_iter=10, S=1000, β=0)
    ...
    save("logistic_regression_QNC_" * args[3] * "_" * args[1] * ".jld", "θs", θs, "c_lp", c_lp, "c_g_lp", c_g_lp,
