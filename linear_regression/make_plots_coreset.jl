...
Threads.@threads for i in 1:n_run
    ...
    for j in 1:dat_size
        ...
        if j > 3
            KL_qnc[i,j] = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "kl")
        end
    end
end
...
Threads.@threads for i in 1:n_run
    ...
    for j in 1:dat_size
        ...
        m_method = load("linear_regression_uniform_" * string(Ms[j]) * "_" * string(i) * ".jld", "mean")
        mrel_unif[i,j] = norm(m_method - stan_mean) / norm(stan_mean)
        if j > 3
            m_method = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "mean")
...
Threads.@threads for i in 1:n_run
    ...
    for j in 1:dat_size
        ...
        m_method = load("linear_regression_uniform_" * string(Ms[j]) * "_" * string(i) * ".jld", "cov")
        srel_unif[i,j] = norm(m_method - stan_cov) / norm(stan_cov)
        if j > 3
            m_method = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "cov")
...
for i in 1:n_run
    ...
    for j in 1:dat_size
        ...
        m_method = load("linear_regression_SHF_" * string(Ms[j]) * "_" * string(i) * ".jld", "θs")
        time = load("linear_regression_SHF_" * string(Ms[j]) * "_" * string(i) * ".jld", "c_time")
        ...
        m_method = load("linear_regression_uniform_" * string(Ms[j]) * "_" * string(i) * ".jld", "θs")
        time = load("linear_regression_uniform_" * string(Ms[j]) * "_" * string(i) * ".jld", "c_time")
        ...
        if j > 3
            m_method = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "θs")
            time = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "c_time")
...
Threads.@threads for i in 1:n_run
    ...
    for j in 1:dat_size
        ...
        m_method = load("linear_regression_uniform_" * string(Ms[j]) * "_" * string(i) * ".jld", "c_time")
        train_unif[i,j] = m_method[1]
        if j > 3
            m_method = load("linear_regression_QNC_" * string(Ms[j]) * "_" * string(i) * ".jld", "c_time")
